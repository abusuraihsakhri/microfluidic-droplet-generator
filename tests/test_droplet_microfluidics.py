...
import pytest
from droplet_microfluidics.models import FrontierPayload, ExecutionStatus
from droplet_microfluidics.engine import FrontierDomainEngine
from droplet_microfluidics.agents import CapillaryNumberPredictorAgent, PoissonEncapsulationAgent, DropletMonodispersityAgent, DropletMicrofluidicsCoordinator
from droplet_microfluidics.cli import main


def test_sub_agents():
    a1 = CapillaryNumberPredictorAgent()
...
def test_coordinator():
    coord = DropletMicrofluidicsCoordinator()
    ...
    assert "Microfluidic Drop-Seq Standards" in ans or "specifications" in ans
