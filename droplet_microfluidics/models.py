"""
Data Models & Telemetry Definitions for DropletFlow: Microfluidic Flow-Focusing Droplet Generator Agent.
...
class AgentTelemetryAlert:
    ...
    standard_reference: str = "Microfluidic Drop-Seq Standards"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
